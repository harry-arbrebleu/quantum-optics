...
ax1.text(5.4, 1, r"$q$", fontsize=16, ha='center')
ax1.text(1, 24.2, r"$h(q), E$", fontsize=16, ha='center')
...
# print(sympy.integrate(h[0] ** 2, (x, - sympy.oo, sympy.oo)))
for i in range(n):
